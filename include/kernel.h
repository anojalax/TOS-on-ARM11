...
#define GPSET           7       /* GPIO Pin Output Set Register         0x1c */
#define GPCLR           10      /* GPIO Pin Output Clear Register       0x28 */
#define GPLEV           13      /* GPIO Pin Level Register              0x34 */
#define GPPUD           37      /* GPIO Pull-Up/Down Register           0x94 */
#define GPPUDCLK        38      /* GPIO Pull-Up/Down Clock Register     0x98 */
